...
class LicenseManagerActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Button>(R.id.copyTokenButton).setOnClickListener {
            copyToClipboard("MyAdv License Token", token.text.toString().trim())
        }
    ...
    private fun copyToClipboard(label: String, value: String) {
        if (value.isBlank() || value == "Generated automatically") {
