...
class LicenseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar?.title = "Admin License Center"
        ...
        val keyStatus = findViewById<TextView>(R.id.txtAdminKeyStatus)
        ...
        fun refresh() {
            ...
            keyStatus.text = if (OfflineLicenseIssuer.hasSigningKey(this))
                "Admin signing key: CONFIGURED (encrypted on this device)"
            else "Admin signing key: NOT CONFIGURED"
        }

        findViewById<Button>(R.id.btnSaveAdminKey).setOnClickListener {
        ...
        findViewById<Button>(R.id.btnGenerateLicense).setOnClickListener {
        ...
        findViewById<Button>(R.id.btnShareGenerated).setOnClickListener {
