    ...
    private fun setupButtons() {
        ...
        btnSaveSettings.setOnClickListener {
            ...
            if (nameColumn.isEmpty()) {
                ...
                edtNameColumn.requestFocus()
                return@setOnClickListener
            }

            if (phoneColumn.isEmpty()) {
                edtPhoneColumn.error = "Enter Phone column"
                edtPhoneColumn.requestFocus()
                return@setOnClickListener
            }

            if (defaultMessage.isEmpty()) {
                edtDefaultMessage.error = "Enter default message"
                edtDefaultMessage.requestFocus()
                return@setOnClickListener
            }
