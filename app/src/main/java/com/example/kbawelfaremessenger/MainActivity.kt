...
class MainActivity : AppCompatActivity() {
    ...
    private fun ensureSmsPermission() {
        ...
        if (
            ...
            if (
                adapter.getSelectedContacts().isEmpty()
            ) {
...
class SmsWorker(
    ...
    private val smsPermission =
        registerForActivityResult(
            ...
            if (granted) {
                ...
                status.text = "SMS permission was not granted."
            }
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        try {
            ...
            message.setText(
                getPreferences(0).getString("draft", "")
            )
            ...
            findViewById<Button>(R.id.btnSaveDraft).setOnClickListener {
                getPreferences(0)
                    .edit()
                    .putString("draft", message.text.toString())
                    .apply()
            ...
            findViewById<Button>(R.id.btnCancelSchedule).setOnClickListener {
                WorkManager
                    .getInstance(this)
                    .cancelUniqueWork("kba_sms_schedule")
            ...
            findViewById<Button>(R.id.btnReset).setOnClickListener {
                ...
                from.setText("1")
                to.setText(
                    minOf(100, contacts.size).toString()
                )
                whatsappIndex = 0
                status.text =
                    "Actions/filters reset. Stored contacts kept."
            }
            ...
            findViewById<Button>(R.id.btnClearData).setOnClickListener {
                ...
                stats.text =
                    "People: 0 | Individual numbers: 0"

                findViewById<TextView>(R.id.txtFile).text =
                    "No file selected"

                status.text =
                    "Stored contacts removed. Draft kept."
            }
    ...
    private fun loadCsv(uri: Uri) {
        ...
        try {
                ...
                .use { input ->
                    ...
                    lines
                        ...
                        .forEachIndexed { index, line ->
                            ...
                            addContact(
                                row.getOrNull(nameIndex)
                                    .orEmpty(),

                                row.getOrNull(phoneIndex)
                                    .orEmpty(),
            ...
            status.text =
                "Loaded ${contacts.size} individual numbers."
    ...
    private fun preview() {
        ...
        val list =
            filteredContacts().take(5)

        if (list.isEmpty()) {

            toast(
                "No contacts in the selected range"
            )
    ...
    private fun testSms() {
        ...
        try {
            ...
            status.text =
                "Test SMS requested for ${c.name} (${c.phone})"
    ...
    private fun nextWhatsApp() {
        ...
        status.text =
            "WhatsApp ${whatsappIndex}/${list.size}: ${c.name}"

        startActivity(
            Intent(
                Intent.ACTION_VIEW,
                Uri.parse(
                    "https://wa.me/${c.phone}?text=${
                        Uri.encode(
                            personalize(c)
                        )
                    }"
